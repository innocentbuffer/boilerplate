<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('images/logo/bslogo.png') }}" width="50" height="25" alt="Bluesparrow Logo">
        <img class="navbar-brand-minimized" src="{{ asset('images/logo/bslogo.png') }}" width="30" height="30" alt="Bluesparrow Logo">
    </a>
